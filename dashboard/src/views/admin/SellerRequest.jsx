                        ...
                        <tbody>
                            {
                                ...
                                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>{d}</td>
                                    <td scope='row' className='py-2 px-4 font-medium whitespace-nowrap'>dreiXcode</td>
                                    <td scope='row' className='py-2 px-4 font-medium whitespace-nowrap'>dreix@gmail.com</td>
                                    <td scope='row' className='py-2 px-4 font-medium whitespace-nowrap'><span>Inactive</span></td>
                                    <td scope='row' className='py-2 px-4 font-medium whitespace-nowrap'><span>Pending</span></td>
