                        ...
                        <div className='w-[30%]'>
                            <div className='pr-3 text-[#d0d2d6] text-lg'>
                                <div className='flex flex-col gap-1'>
                                    <h2 className='pb-2 font-semibold'>Delivered To: dreiXcode</h2>
                                    <p><span className='text-sm'>Frederick Nebraska 20620</span></p>
                                </div>
                                        ...
                                        <div className='flex gap-3 text-md'>
                                            ...
                                            <div>
                                                ...
                                                <p>
                                                    <span>Brand : </span>
                                                    <span>Easy</span>
                                                    <span className='text-lg'>Qauntity : 3</span>
                                                </p>    
                                            </div>
                                        </div>
                                    </div>                                    
