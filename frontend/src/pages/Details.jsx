                    ...
                    <div className='grid grid-cols-2 md-lg:grid-cols-1 gap-8'>
                        ...
                        <div className='flex flex-col gap-5'>
                            ...
                            <div className='flex gap-3'>
                                {
                                    stock ? <button className='px-8 py-3 h-[50px] cursor-pointer hover:shadow-lg hover:shadow-green-500/40 bg-[#247462] text-white'>
                                        Buy Now
                                    </button> : ''
                                }
                                <Link t0='#' className='px-8 py-3 h-[50px] cursor-pointer hover:shadow-lg hover:shadow-red-500/40 bg-red-500 text-white'>
                                    Chat Seller
                                </Link>
                            </div>
                    ...
                    <div className='flex flex-wrap'>
                        <div className='w-[72%] md-lg:w-full'>
                            <div className='pr-4 md-lg:pr-0'>
                                ...
                                <div>
                                    {
                                        state === 'reviews' ? <Reviews/> : <p className='py-5 text-slate-500'>
