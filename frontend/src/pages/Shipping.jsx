                            ...
                            <div className='w-[67%] md-lg:w-full'>
                                <div className='flex flex-col gap-3'>
                                    <div className='bg-white p-6 shadow-sm rounded-md'>
                                                ...
                                                <form onSubmit={save}>
                                                    ...
                                                    <div className='flex md:flex-col md:gap-2 w-full gap-5 text-slate-600'>
                                                        ...
                                                        <div className='flex flex-col gap-1 mt-7 mb-2 w-full'>
                                                            <button className='px-3 py-[6px] rounded-sm hover:shadow-green-500/50 hover:shadow-lg bg-green-500 text-white'>Save Changes</button>
                                                        </div>
                                        ...
                                        {
                                            res && <div className='floex flex-col gap-1'>
                                                <h2 className='text-slate-600 font-semibold pb-2'>Delivered To {state.name}</h2>
                                                <p>
                                                ...
                                                <p className='text-slate-600 text-sm'>Email to dreixCode@gmail.com</p>
                            ...
                            <div className='w-[33%] md-lg:w-full'>
                                <div className='pl-3 md-lg:pl-0 md-lg:mt-5'>
                                    <div className='bg-white p-3 text-slate-600 flex flex-col gap-3'>
                                            ...
                                            <div className='flex justify-between items-center'>
                                                <span>Total</span>
                                                <span className='text-lg text-[#059473]'>$99</span>
                                            </div>
                                            <button disabled={res ? false : true } className={`px-5 py-[6px] rounded-sm hover:shadow-red-500/50 hover:shadow-lg ${res ? 'bg-red-500' : 'bg-red-300'} bg-red-500 text-sm text-white uppercase`}>
                                                Place Order
                                            </button>
