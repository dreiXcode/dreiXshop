                    ...
                    <div className='flex justify-start flex-col gap-6'>
                        ...
                        <div className='w-full flex justify-end md-lg:justify-start gap-3 items-center'>
                            ...
                            <div className='flex justify-end flex-col gap-1'>
                                <h2 className='text-sm font-medium text-slate-700'>+12342424242</h2>
                                <span className='text-sm'>Support 24/7</span>
                            </div>
                        </div>

                        <div className='flex flex-col justify-start items-start gap-3 text-[#1c1c1c]'>
                                        ...
                                        categories.map((c,i) => {
                                            return (
                                                <li key={i} className='flex justify-start items-center gap-2 px-[24px] py-[6px]'>
                                                    <img src={c.image} className='w-[30px] h-[30px] rounded overflow-hidden' alt="" />
                        ...
                        <div className='flex flex-wrap w-full justify-between items-center md-lg:gap-6'>
                            ...
                            <div className='w-4/12 block md-lg:hidden pl-2 md-lg:w-full md-lg:pl-0'>
                                ...
                                <div className='w-full flex justify-end md-lg:justify-start gap-3 items-center'>
                                    ...
                                    <div className='flex justify-end flex-col gap-1'>
                                        <h2 className='text-md font-medium text-slate-700'>+1265524242</h2>
                                        <span className='text-sm'>Support 24/7</span>
                                    </div>
                                </div>
